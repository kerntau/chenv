...
function generateCoverSvg(post) {
  ...
  <g transform="translate(120, 150)">
    ...
    <text x="240" y="24" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="13" font-weight="500" fill="rgba(255,255,255,0.45)" letter-spacing="2">CHENV.CN ARCHITECTURE SERIES</text>
    ...
    <g transform="translate(0, 540)">
      ...
      <text x="32" y="16" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="14" font-weight="600" fill="#FFFFFF" letter-spacing="2">CHENV.CN</text>
