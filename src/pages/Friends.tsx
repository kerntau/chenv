  ...
  return (
    <PageShell>
      <Container>
        ...
        <div className="mb-8 pb-6 border-b border-slate-200/70 dark:border-slate-800/70">
          ...
          <div className="mt-5 relative max-w-sm">
            ...
            <input
              ...
              className="w-full pl-9 pr-3.5 py-1.5 rounded-full text-xs bg-slate-100/80 dark:bg-slate-800/80 border border-slate-200/80 dark:border-slate-700/80 text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 transition-all"
            />
          </div>
        </div>
        ...
        {/* 申请友链指南 */}
        <div className="p-6 rounded-3xl paper-card space-y-3 bg-slate-50/50 dark:bg-[#18181A]/50">
          ...
          <div className="p-3.5 rounded-xl bg-white/70 dark:bg-slate-900/70 border border-slate-200/50 dark:border-slate-800/50 text-xs font-mono text-slate-600 dark:text-slate-400 space-y-1">
...
const FriendCard: React.FC<{ friend: FriendItem }> = ({ friend }) => {
  ...
  return (
    ...
    >
      <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-100 flex items-center justify-center font-sans text-sm font-bold shrink-0 overflow-hidden group-hover:scale-105 transition-transform border border-slate-200/50 dark:border-slate-700/50">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between">
          <h3 className="font-sans text-sm font-semibold text-slate-900 dark:text-slate-100 group-hover:text-sky-600 dark:group-hover:text-sky-400 transition-colors truncate">
            {friend.name}
          </h3>
          <ArrowUpRight className="w-3 h-3 text-slate-400 group-hover:text-sky-600 dark:group-hover:text-sky-400 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all shrink-0 ml-1" />
        </div>
