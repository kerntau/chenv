        ...
        <div className="space-y-6">
          {records.map((record) => (
            ...
            >
              ...
              {/* 内容 */}
              <p className="font-sans text-sm sm:text-base text-stone-800 dark:text-stone-200 leading-relaxed font-normal">
                {record.content}
              </p>
              ...
              <div className="pt-2 flex items-center justify-between border-t border-stone-200/50 dark:border-stone-800/50 text-xs font-mono">
                <div className="flex items-center space-x-1 text-stone-400 dark:text-stone-500 text-[11px]">
                  {record.location && (
                    <>
